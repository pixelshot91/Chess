  ...
  */
  ...
  public:
    ...
    */
    virtual
    void
    register_board(const ChessboardInterface& board_interface) = 0;
    ...
    */
    virtual
    void
    on_piece_moved(const PieceType piece,
                   const Position& from,
                   const Position& to) = 0;
    ...
    */
    virtual
    void
    on_piece_taken(const PieceType piece,
                   const Position& at) = 0;
    ...
    */
    virtual
    void
    on_piece_promoted(const PieceType piece,
                      const Position& at) = 0;
...
/**
** This macro creates a function `listener_create` when the listener is built.
