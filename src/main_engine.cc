...
int main(int argc, char *argv[])
{
  ...
  desc.add_options()("help,h",
                     "show usage")("port,p", po::value<unsigned short>(),
                                   "select the listening port for the network")("pgn", po::value<std::string>(), "path to the PGN game file")("listeners,l",
  ...
  Engine engine(listeners, port, pgn_path);
  engine.start();
